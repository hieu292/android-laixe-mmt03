...
public class BienBaoAdapter extends BaseAdapter {
	...
	public View getView(int paramInt, View paramView, ViewGroup paramViewGroup) {
		BienBao localItemBienbao = (BienBao) this.list_bienbao.get(paramInt
				+ this.start);
		View localView = this.li.inflate(R.layout.bienbao_gridview, paramViewGroup, false);
		this.image = ((ImageView) localView.findViewById(R.id.bienbao_grid_item_image));
		this.ten_bienbao = ((TextView) localView.findViewById(R.id.bienbao_grid_item_text));
		this.ten_bienbao.setText(localItemBienbao.id);
		this.image.setImageResource(((Integer) this.map
				.get(localItemBienbao.link_anh)).intValue());
		return localView;
	}
}