...
public class KetQuaMotAccount extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences NGTShared = getSharedPreferences(UserAction.START_TIME, 0);
	...
	public void createLayoutViewResult(final Context _context, final long ngaygiothi, String tenaccount){
		...
		ngayGioThi.setText("Ngày thi: " + ngay +"/"+ thang +"/"+ nam + "      " + gio + ":" + phut + "':" + giay + "\"");
		...
		thoigianthi.setText("Thời gian làm bài: " + minsec[0]  + "':" + minsec[1] + "\"");
		
		diemThi.setText("Điểm thi: " + ketqua);
		if(ketqua >= 26){
			doTruot.setText("Đỗ / Trượt: " + "\n" + "Bạn đã vượt qua! Xin chúc mừng." );
		}
		else
		{
			doTruot.setText("Đỗ / Trượt:  "+ "\n" + "Bạn chưa vượt qua! Hãy cố gắng lần sau." );
		}
	...
	/**
	 * Hàm trả về một mảng các câu trả lời đúng, sai, hoặc chưa trả lời của đề thi thuộc user tại thời điểm cho trước.
	 * @param _context
	 * @param ngaygiothi
	 * @return
	 */
	...
	{
		//lay ve idBoDe, idUser, thoigianhoanthanh, ketqua thi tai thoi gian cho truoc
		int idUser = 0;
	...
	public void suaHinhDung(int idCau){
		...
		case 9: 			
			...
			break;
		case 10: 			
			imageKetQuaCau11.setBackgroundResource(com.uit.R.drawable.nt_elevent);
			break;
		case 11: 			
			imageKetQuaCau12.setBackgroundResource(com.uit.R.drawable.nt_twelve);
			break;
		case 12: 			
			imageKetQuaCau13.setBackgroundResource(com.uit.R.drawable.nt_thirteen);
			break;
		case 13: 			
			imageKetQuaCau14.setBackgroundResource(com.uit.R.drawable.nt_fourteen);
			break;
		case 14: 			
			imageKetQuaCau15.setBackgroundResource(com.uit.R.drawable.nt_fifteen);
			break;
		case 15: 			
			imageKetQuaCau16.setBackgroundResource(com.uit.R.drawable.nt_sixteen);
			break;
		case 16: 			
			imageKetQuaCau17.setBackgroundResource(com.uit.R.drawable.nt_seventeen);
			break;
		case 17: 			
			imageKetQuaCau18.setBackgroundResource(com.uit.R.drawable.nt_eighteen);
			break;
		case 18: 			
			imageKetQuaCau19.setBackgroundResource(com.uit.R.drawable.nt_nineteen);
			break;
		case 19: 			
			imageKetQuaCau20.setBackgroundResource(com.uit.R.drawable.nt_twenty);
			break;
		case 20: 			
		...
		case 21: 			
			...
			break;
		case 22: 			
			imageKetQuaCau23.setBackgroundResource(com.uit.R.drawable.nt_t_three);
			break;
		case 23: 			
			imageKetQuaCau24.setBackgroundResource(com.uit.R.drawable.nt_t_four);
			break;
		case 24: 			
			imageKetQuaCau25.setBackgroundResource(com.uit.R.drawable.nt_t_five);
			break;
		case 25: 			
			imageKetQuaCau26.setBackgroundResource(com.uit.R.drawable.nt_t_six);
			break;
		case 26: 			
			imageKetQuaCau27.setBackgroundResource(com.uit.R.drawable.nt_t_seven);
			break;
		case 27: 			
			imageKetQuaCau28.setBackgroundResource(com.uit.R.drawable.nt_t_eight);
			break;
		case 28: 			
			imageKetQuaCau29.setBackgroundResource(com.uit.R.drawable.nt_t_nine);
			break;
		case 29: 			
			imageKetQuaCau30.setBackgroundResource(com.uit.R.drawable.nt_thirty);
			break;
		}
	}
	...
	public void suaHinhSai(int idCau){
		...
		case 9: 			
			...
			break;
		case 10: 			
			imageKetQuaCau11.setBackgroundResource(com.uit.R.drawable.nf_elevent);
			break;
		case 11: 			
			imageKetQuaCau12.setBackgroundResource(com.uit.R.drawable.nf_twelve);
			break;
		case 12: 			
			imageKetQuaCau13.setBackgroundResource(com.uit.R.drawable.nf_thirteen);
			break;
		case 13: 			
			imageKetQuaCau14.setBackgroundResource(com.uit.R.drawable.nf_fourteen);
			break;
		case 14: 			
			imageKetQuaCau15.setBackgroundResource(com.uit.R.drawable.nf_fifteen);
			break;
		case 15: 			
			imageKetQuaCau16.setBackgroundResource(com.uit.R.drawable.nf_sixteen);
			break;
		case 16: 			
			imageKetQuaCau17.setBackgroundResource(com.uit.R.drawable.nf_seventeen);
			break;
		case 17: 			
			imageKetQuaCau18.setBackgroundResource(com.uit.R.drawable.nf_eighteen);
			break;
		case 18: 			
			imageKetQuaCau19.setBackgroundResource(com.uit.R.drawable.nf_nineteen);
			break;
		case 19: 			
			imageKetQuaCau20.setBackgroundResource(com.uit.R.drawable.nf_twenty);
			break;
		case 20: 			
		...
		case 21: 			
			...
			break;
		case 22: 			
			imageKetQuaCau23.setBackgroundResource(com.uit.R.drawable.nf_t_three);
			break;
		case 23: 			
			imageKetQuaCau24.setBackgroundResource(com.uit.R.drawable.nf_t_four);
			break;
		case 24: 			
			imageKetQuaCau25.setBackgroundResource(com.uit.R.drawable.nf_t_five);
			break;
		case 25: 			
			imageKetQuaCau26.setBackgroundResource(com.uit.R.drawable.nf_t_six);
			break;
		case 26: 			
			imageKetQuaCau27.setBackgroundResource(com.uit.R.drawable.nf_t_seven);
			break;
		case 27: 			
			imageKetQuaCau28.setBackgroundResource(com.uit.R.drawable.nf_t_eight);
			break;
		case 28: 			
			imageKetQuaCau29.setBackgroundResource(com.uit.R.drawable.nf_t_nine);
			break;
		case 29: 			
			imageKetQuaCau30.setBackgroundResource(com.uit.R.drawable.nf_thirty);
			break;
		}
	}
